...
verhaalLijst = ["NUL",
                ...
                "eenmaal daar die je veel docenten weer en praat je bij met je klasgenoten, je vertelt ze over de reis naar het buitenland die je wilt gaan maken, spannend! Ga je met het vliegtuig of rijden?",
                "Slim! Je slaagt en hebt je vakantie dubbel verdient!",
                "Je krijgt een uitnodiging binnen voor je diploma-uitreiking, eenmaal daar die je veel docenten weer en praat je bij met je klasgenoten,\nje vertelt ze over de reis naar het buitenland die je wilt gaan maken, spannend!",
                ...
                "Na 2,5 week het leuk gehad met al deze mensen overweeg je om weer verder te liften, ga je dat ook doen? Er is vanavond een feetje op het strand, wil je nog 1 weekend blijven?",
                "Het was heel gezellig, maar je gaat weer door, de groep zet je af bij een groot winkelcentrum met allemaal verschillende winkels, terwijl je rondloopt kom je een makelaarsbedrijfje tegen.",
                ...
                "Je komt het bos niet meer uit, je moet hier nu zien te overleven en hopen dat je nog mensen al zien binnenkort, succes…. ",
                ...
                "Ze vragen je een liedje met hen te spelen en mee te gaan naar hun volgende show, of je dat wil?",
                ...
                "Goede keuze! Jij bent degene die vanavond iedereen veilig meeneemt naar een plek om te slapen vannacht, je hebt het heel erg naar je zin gehad vannacht en besluit bij deze groep te blijven.",
                "Wie weet wat het je allemaal nog gaat brengen.",
                "na het vliegen wil je gaan rondtrippen door Italië, en gaan liften, je wacht bij het vliegveld waar je net geland bent,"]
...
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
def fout():
    while antwoord9 != "A" and antwoord9 != "B":
        print("probeer opnieuw, let op, hoofdletters! laatste kans")     
